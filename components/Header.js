    ...
    return (
        ...
        <header className='sticky z-50 top-0 grid grid-cols-3 bg-zinc-50 p-5 shadow-md md:px-10'>
            ...
            <div className='flex items-center md:border-2 rounded-full py-2 pr-2 md:shadow-sm'>
                <input value={searchInput} onChange={(e) => setSerchInput(e.target.value)} className='flex-grow pl-5 bg-transparent outline-none text-sm text-gray-600 placeholder-gray-400' type="text" placeholder={placeholder || 'Start your search'} />
